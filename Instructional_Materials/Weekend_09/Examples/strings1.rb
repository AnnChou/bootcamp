...
#the plus signs interpolate the content of the variable to the string.
#if you run this program numerous times, the 'name' variable will change each time depending on the user's input
